...
/**
 * @file
 * Template for the Moscone Flipped Full layout.  Like 1.4 core, but with more markup, classes and wrappers.
 *
 * Variables:
...
<div class="layout--moscone-flipped-full <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <?php endif; ?>
</div><!-- /.layout--moscone-flipped-full -->
