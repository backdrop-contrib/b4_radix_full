...
/**
 * @file
 * Template for the Sutro Full layout.  Like 1.4 core, but with more markup, classes and wrappers.
 *
 * Variables:
...
<div class="layout--sutro-full <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <div class="l-wrapper">
    ...
    <?php if (!empty($content['half1']) || !empty($content['half2']) ): ?>
        <div class="l-middle l-halves">
          <div class="container container-fluid l-halves-inner">
            <div class="row l-halves-inner-2">
              <div class="col-md-6 l-halves-region">
