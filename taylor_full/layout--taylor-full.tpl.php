...
/**
 * @file
 * Template for the Taylor Full layout.  Like 1.4 core, but with more markup, classes and wrappers.
 *
 * Variables:
...
<div class="layout--taylor-full <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
